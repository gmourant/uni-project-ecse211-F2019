...
/**
 * Navigates the robot depending on given coordinates avoids obstacles and
 * resumes navigation
 *
 * @author Steven
 * @author Hassan
...
public class Navigation {
	...
	/**
	 * Orientates robot towards desired destination rotates forward to the
	 * coordinate and resumes when avoided
	 *
...
//	        obstacleDetected = true;
	...
	/**
	 * finds the ideal launch position to launch a projectile r distance away from
	 * given point
	 *
	...
	/**
	 * finds an alternate launch position to launch a projectile r distance away
	 * from given point. This is required in case the previously computed ideal
	 * launch point is not on the island.
	 *
	 * @param x  coordinates of x
	 * @param y  coordinates of y
	 * @param r  radius of position
  ...
  public static void goMid(boolean back) {
	 ...
	 * that distance. From Lab 2 SquareDriver.java
	 *
	 * @param distance
	 ...
	 * robot by that angle. From Lab 2 SquareDriver.java
	 *
	 * @param angle
